...
def developed_by(x, y):
    dev = dev_font.render("By Szidonia", 1, (255, 0, 0))
    screen.blit(dev, (x, y))
...
def intro_title(x, y):
    title = intro_font.render("Enjoy the game!", 1, (255, 0, 0))
...
def you_lose(x, y):
    lose_label = winlose_font.render("YOU LOST :( ", True, (255, 255, 255))
...
# background music
mixer.music.load("Without-Fear.mp3")
mixer.music.play(-1)
